...
async def test_prometheus_metrics_full_jubilant(
    juju: jubilant.Juju,
    ...
    """Fully jubilant variant — no python-libjuju awaits after fixture setup.
    ...
    # --- Runner lifecycle via jubilant (no python-libjuju) ---
...
def _wait_for_no_runners(juju: jubilant.Juju, app_name: str) -> None:
    ...
    while time.monotonic() < deadline:
        ...
        if (
            ...
            return
        time.sleep(10)
    raise TimeoutError(f"Runners on {unit} still present after 10 minutes")
