...
async def app_for_jobmanager_fixture(
    ...
    #     {"script-url": "https://pastebin.canonical.com/p/qVZyGB6Cz7/"}
    # )
...
def test_jobmanager(monkeypatch: pytest.MonkeyPatch, app: Application):
    """
    arrange: TODO.
    act: TODO.
    assert: TODO.
    ...
    with TestServer(monkeypatch, ("", 8000)) as httpd:
        httpd.handle_get_request("", "hello", timeout=5)
