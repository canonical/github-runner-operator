...
from charm_state import (
    ...
    LABELS_CONFIG_NAME,
    LABELS_RELATION_KEY,
    MINIMUM_PRESSURE_RELATION_KEY,
    MONGO_DB_INTEGRATION_NAME,
    OPENSTACK_CLOUDS_YAML_CONFIG_NAME,
    OPENSTACK_FLAVOR_CONFIG_NAME,
    PATH_CONFIG_NAME,
    PLANNER_INTEGRATION_NAME,
    PLATFORM_RELATION_KEY,
    PRIORITY_RELATION_KEY,
    TOKEN_CONFIG_NAME,
...
def test_planner_relation_changed_writes_flavor(monkeypatch: pytest.MonkeyPatch):
    ...
    assert harness.get_relation_data(relation_id, harness.charm.app) == {
        ...
        LABELS_RELATION_KEY: '["label1", "label2"]',
        PLATFORM_RELATION_KEY: FLAVOR_DEFAULT_PLATFORM,
        PRIORITY_RELATION_KEY: str(FLAVOR_DEFAULT_PRIORITY),
        MINIMUM_PRESSURE_RELATION_KEY: "3",
    }
