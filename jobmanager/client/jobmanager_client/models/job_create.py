...
class JobCreate(BaseModel):
    ...
    __properties = ["requested_by", "repository_url", "repository_ref", "architecture", "base_series", "vm_dependencies", "commands", "secrets", "environment", "artifacts_dir", "topology", "vm_ip", "vm_size", "status", "artifact_urls", "log_urls"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobCreate:
        """Create an instance of JobCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobCreate.parse_obj(obj)

        _obj = JobCreate.parse_obj({
