...
class V1JobsJobIdTokenPostRequest(BaseModel):
    """
    ...
    __properties = ["public_key", "private_key", "job_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1JobsJobIdTokenPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1JobsJobIdTokenPostRequest:
        """Create an instance of V1JobsJobIdTokenPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1JobsJobIdTokenPostRequest.parse_obj(obj)

        _obj = V1JobsJobIdTokenPostRequest.parse_obj({
