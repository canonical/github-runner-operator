...
class V1JobsJobIdHealthPutRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1JobsJobIdHealthPutRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1JobsJobIdHealthPutRequest:
        """Create an instance of V1JobsJobIdHealthPutRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1JobsJobIdHealthPutRequest.parse_obj(obj)

        _obj = V1JobsJobIdHealthPutRequest.parse_obj({
            "label": obj.get("label"),
