...
class DefaultApi:
    ...
    def health_check_health_get(self, **kwargs) -> object:  # noqa: E501
        ...
        Health check endpoint for monitoring service status.  This endpoint can be used by monitoring tools and load balancers to verify the service is operational.  Returns:     dict: Contains status indicating service health  # noqa: E501
    ...
    def root_get(self, **kwargs) -> object:  # noqa: E501
        ...
        Root endpoint providing basic API information.  Returns:     dict: Basic API information including:         - message: API identification         - version: Current API version         - status: Running status  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
