...
Arrange–Act–Assert docstrings clarify intent for each test.
"""
...
class _FakeManager:
    ...
    def create_runners(self, num: int, metadata):  # noqa: ARG002
...
class _FakePlanner:
    def __init__(
        ...
        self.last_pressure_requested_for_flavor = None
