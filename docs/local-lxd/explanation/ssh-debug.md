...
Authorized keys are registered through [action-tmate](https://github.com/canonical/action-tmate/)'s
`limit-access-to-actor` feature. This feature uses a GitHub user's SSH key to launch an instance
